...
setup(
    ...
    entry_points={
        "git_theta.plugins.merges": [
            ...
            "slerp = git_theta_merge_cli.merges.slerp:SLERP",
            "slerp-gpu = git_theta_merge_cli.merges.slerp:SLERPGPU",
            "mlerp = git_theta_merge_cli.merges.slerp:MLERP",
            "mlerp-gpu = git_theta_merge_cli.merges.slerp:MLERPGPU",
        ],
        "console_scripts": [
            "git-theta-merge-cli = git_theta_merge_cli.scripts.git_theta_merge:main",
